...
import com.zahra.space.ui.screens.game.QuizGameScreen
import com.zahra.space.ui.screens.game.CookingGameScreen
import com.zahra.space.ui.screens.game.DebatGameScreen
...
fun NavGraph(
    ...
    NavHost(
        ...
        composable(Screen.Game.route) {
            GameHomeScreen(
                onNavigateToQuiz = { navController.navigate("game_quiz") },
                onNavigateToCooking = { navController.navigate("game_cooking") },
                onNavigateToDebat = { navController.navigate("game_debat") }
            )
        }
        
        composable("game_quiz") {
            QuizGameScreen()
        }
        
        composable("game_cooking") {
            CookingGameScreen()
        }
        
        composable("game_debat") {
            DebatGameScreen()
        }
